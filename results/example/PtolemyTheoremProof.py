...
class PtolemyTheoremProof(Scene):
    ...
    def construct(self):
        ...
        A = self.point_on_circle(center, radius, 150)
        B = self.point_on_circle(center, radius, 40)
        C = self.point_on_circle(center, radius, -45)
        D = self.point_on_circle(center, radius, -155)
        ...
        theorem_title = self.make_text("定理结论", 30, BLUE_D)
        theorem_title.move_to(theorem_box.get_top() + DOWN * 0.35)
        ...
        self.fit_width(theorem_formula, theorem_box.width - 0.75)
        theorem_formula.move_to(theorem_box.get_center() + DOWN * 0.22)
        ...
        self.fit_width(condition, theorem_box.width - 0.7)
        ...
        self.fit_width(construct_text, 6.1)
        ...
        step1_title = self.make_text("第一组图形关系", 25, GREEN_D)
        step1_l1 = self.make_text("∠ABE = ∠DBC", 23, BLACK)
        step1_l2 = self.make_text("∠BAE = ∠BDC", 23, BLACK)
        step1_l3 = self.make_text("所以 △ABE ∽ △DBC", 24, RED_D)
        step1_l4 = self.make_text("推出：AE × BD = AB × CD", 24, RED_D)
        ...
        self.fit_width(step1, step1_box.width - 0.7)
        ...
        step2_title = self.make_text("第二组图形关系", 25, PURPLE_D)
        step2_l1 = self.make_text("∠ABD = ∠EBC", 23, BLACK)
        step2_l2 = self.make_text("∠ADB = ∠ECB", 23, BLACK)
        step2_l3 = self.make_text("所以 △ABD ∽ △EBC", 24, RED_D)
        step2_l4 = self.make_text("推出：EC × BD = AD × BC", 24, RED_D)
        ...
        self.fit_width(step2, step2_box.width - 0.7)
        ...
        f1 = self.make_text("AE × BD = AB × CD", 23, GREEN_D)
        f2 = self.make_text("EC × BD = AD × BC", 23, PURPLE_D)
        f3 = self.make_text("两式相加：", 22, BLACK)
        f4 = self.make_text(
            "(AE + EC) × BD = AB × CD + AD × BC",
            21,
            BLACK
        )
        f5 = self.make_text("因为 AE + EC = AC", 22, BLACK)
        f6 = self.make_text(
        ...
        self.fit_width(formulas, formula_box.width - 0.75)
        ...
        final_title = self.make_text("托勒密定理成立", 34, RED_D)
