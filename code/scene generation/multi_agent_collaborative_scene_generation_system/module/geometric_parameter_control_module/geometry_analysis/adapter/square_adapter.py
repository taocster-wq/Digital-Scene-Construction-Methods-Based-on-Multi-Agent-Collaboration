...
class SquareAdapter(GeometryAdapter):
    """正方形适配器"""
    ...
    def draw(self, ax):
        ...
        square = Polygon([vA, vB, vC, vD], closed=True, fill=False, edgecolor='orange', linewidth=2)
        ax.add_patch(square)
        ax.plot(vA[0], vA[1], 'o', color='orange', markersize=8)
        ax.plot(vB[0], vB[1], 'o', color='orange', markersize=8)
        ax.plot(vC[0], vC[1], 'o', color='orange', markersize=8)
        ax.plot(vD[0], vD[1], 'o', color='orange', markersize=8)